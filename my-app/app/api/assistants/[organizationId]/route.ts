...
export async function PUT(
  ...
  try {
    ...
    console.log('Updating assistant ID:', id, 'in organization:', organizationId, 'with data:', updateData)
...
export async function DELETE(
  ...
  try {
    ...
    console.log('Deleting assistant ID:', assistantId, 'from organization:', organizationId)
