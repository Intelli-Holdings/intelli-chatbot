...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${BASE_URL}/contacts/contacts/bulk_remove_tags/`, {
      method: "POST",
      headers: {
    ...
    logger.error("Error bulk removing tags", { error: error instanceof Error ? error.message : String(error) })
