...
import { Search, Phone, Video, MoreHorizontal, Star, Sparkles, BadgeCheck, Filter } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"

const mockThreads = [
  { id: "m-1", name: "Avery Ross", preview: "Hey! Can you share pricing?", time: "2m", unread: true },
  { id: "m-2", name: "Jordan Lee", preview: "Thanks, that helps a lot.", time: "18m", unread: false },
  { id: "m-3", name: "Mila Patel", preview: "I need support with my order.", time: "1h", unread: false },
  { id: "m-4", name: "Chris Stone", preview: "Any updates on shipping?", time: "3h", unread: false },
]
