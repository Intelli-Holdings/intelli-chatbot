                ...
                <div className="p-4">
                  ...
                  <div className="mt-6">
                    ...
                    {analytics?.phoneNumberLimits?.map((phoneLimit, index) => (
                      <div
                        key={index}
                        className="grid grid-cols-3 gap-4 border-t py-4"
                      >
                        <div className="flex items-center gap-2">
                          <div className="flex h-8 w-8 items-center justify-center  bg-blue-100"></div>
                          <div>
                            <div className="text-sm font-medium">
                              {phoneLimit.phone_number}
                            </div>
                        ...
                        <div className="flex items-center">
                          <span>
                            {phoneLimit.business_initiated_conversations} of{" "}
                            {phoneLimit.limit} used
                          </span>
                        </div>
                      </div>
                    )) ||
                      (selectedAppService ? (
                        <div className="grid grid-cols-3 gap-4 border-t py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-1 text-xs text-muted-foreground">
                                <span className="inline-block h-3 w-4 overflow-hidden rounded-sm"></span>
                                Loading...
                              </div>
                            </div>
                          </div>
                          <div className="flex items-center">
                            <span>
                              {selectedAppService.name || "Loading..."}
                            </span>
                          </div>
                          <div className="flex items-center">
                            <span>
                              {isLoading ? "Loading..." : "0 of 250 used"}
                            </span>
                          </div>
                        </div>
                      ) : (
                ...
                <Card className="p-4">
                  <div className="flex flex-col gap-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Business-initiated conversations/phone number
                    </p>
                    ...
                    <div className="border-t pt-4">
                      ...
                      <ol className="list-decimal pl-5 text-sm">
                        <li className="mb-2">
                          Get 1000+ daily business-initiated conversations to
                          increase your customer reach.
                        </li>
                        <li>
                          Show your business display name in chats and
                          notifications so your customers know it&apos;s you.
                        </li>
                      </ol>
                    </div>
