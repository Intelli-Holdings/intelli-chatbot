...
const footerLinks = {
  Product: [
    { label: "Campaign Builder", href: "/features#campaigns" },
    { label: "AI Assistant", href: "/features#ai-assistant" },
    { label: "Multi-Channel Inbox", href: "/features#inbox" },
    { label: "Flow Builder", href: "/features#flows" },
...
export function MarketingFooter() {
  return (
    <footer className="py-16 px-6 bg-[#020617] border-t border-white/[0.06]">
      <div className="max-w-[1200px] mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-white/40 leading-relaxed mb-4 max-w-[240px]">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-8 border-t border-white/[0.06] gap-4">
          <p className="text-sm text-white/30">
            &copy; {new Date().getFullYear()} Intelli Holdings Inc. All rights
            reserved.
          </p>
