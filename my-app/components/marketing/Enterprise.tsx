...
const items = [
  ...
  },
  {
    ...
    description: "Dedicated account manager with priority response SLAs.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Full data protection compliance with EU and global standards.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Complete data isolation between organizations and teams.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-[17px] text-muted-foreground max-w-[600px] mx-auto leading-[1.65]">
            Intelli meets the security, privacy, and compliance requirements of
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((item) => (
            <div
              key={item.title}
              className="p-7 rounded-[14px] bg-white border border-border hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-all"
            >
              <div className="w-10 h-10 rounded-lg bg-dreamBlue/10 flex items-center justify-center text-dreamBlue mb-4">
                {item.icon}
              </div>
