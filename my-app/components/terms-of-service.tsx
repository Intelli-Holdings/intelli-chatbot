...
export default function TermsOfService() {
  ...
  const termsHtml = `
    ...
    <p>Welcome to Intelli Holdings Inc, ("Intelli", "Intelli Holdings Inc", "we", "our", "us"). These Terms of Service ("Terms") govern your use of our services...</p>
...
251 little Falls Drive, city of Wilmington, County of Newcastle, Delaware 19808</p> 
  ...
  const previousTermsHtml = `
    ...
    <p>Welcome to Intelli Holdings Inc, ("Intelli", "Intelli Holdings Inc", "we", "our", "us"). These Terms of Service ("Terms") govern your use of our services, including subscriptions to our Basic Web Widget and WhatsApp offerings. By using our services, you agree to these Terms. If you do not agree, please do not use our services.</p>
