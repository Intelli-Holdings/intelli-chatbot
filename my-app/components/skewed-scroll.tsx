const SkewedInfiniteScroll = () => {
    ...
    {
    id: '7',
    text: 'We used to stress about our business and customers; eversince we put our customer support on autopilot, we got more revenue',
    },
    {
    id: '8',
    text: 'A great innovation, great team and excellent customer care and service',
    },
    ]
    return (
