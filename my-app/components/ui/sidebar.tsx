  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-[--sidebar-width] flex-col hover:bg-blue-100 hover:text-blue-600 text-sidebar-white",
            className
          )}
          ref={ref}
          {...props}
      ...
      return (
        ...
        >
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] hover:bg-blue-100 hover:text-blue-600 p-0 text-sidebar-white [&>button]:hidden"
            style={
              {
